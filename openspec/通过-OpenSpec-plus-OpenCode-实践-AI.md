...
> 文章地址：[https://cloud.tencent.com/developer/article/2616190](https://cloud.tencent.com/developer/article/2616190?from_column=20421&from=20421)
...
现在市面上的辅助编程工具非常多，以标新立异的 Clauda Code 为首，还有 Codex、 Kimi Code CLI、Roo Code 等[命令行工具](https://cloud.tencent.com/product/cli?from_column=20065&from=20065)，以 IDE 交互方式的有 Kiro、VS Code、Cursor 等。所以 Spec 工具不能强依赖一个辅助编程工具，就像 Kiro Spec 只能在 Kiro 下使用，后续迁移到其它辅助编程工具的成本大。
...
![image-20260205210740234](https://developer.qcloudimg.com/http-save/yehe-100000/e13a0997bbf2358ee5364fb8351a4326.png)

image-20260205210740234
...
> 项目地址： [https://github.com/akfamily/akshare](https://cloud.tencent.com/developer/tools/blog-entry?target=https%3A%2F%2Fgithub.com%2Fakfamily%2Fakshare&objectId=2628394&objectType=1&contentType=undefined)

![image-20260205111201148](https://developer.qcloudimg.com/http-save/yehe-100000/0b991c38ec2b7f83e8e0a711b22b3383.png)

image-20260205111201148
...
![image-20260205105136557](https://developer.qcloudimg.com/http-save/yehe-100000/82b0a8305bbc069e2b2c6e4f6b344e55.png)

image-20260205105136557
...
![image-20260205093015893](https://developer.qcloudimg.com/http-save/yehe-100000/100719457d5b43d53a74d6695d8b38cb.png)

image-20260205093015893

![image-20260205093119543](https://developer.qcloudimg.com/http-save/yehe-100000/ddb4e7a64c4593bb106feb1e70f66577.png)

image-20260205093119543

Pencli 支持自动配置到多种辅助编程工具上，你可以在扩展的设置面板配置开启 MCP 功能。

![3e7b50c4-ae7b-46b1-beaa-10b01b010a62](https://developer.qcloudimg.com/http-save/yehe-100000/4714cc123a7f531298b1caea24c86070.png)

3e7b50c4-ae7b-46b1-beaa-10b01b010a62

重启 OpenCode 后发现已自动连接 Pencil 的 MCP 服务器。

![image-20260205112131607](https://developer.qcloudimg.com/http-save/yehe-100000/16a4df2811b080d2db7482282303fe0c.png)

image-20260205112131607

复制 “我需要什么功能” 里面列出的需求，贴到 OpenCode 里面，使用 Plan 模式，然后开始规划设计，跟 AI 不断确认细节。

![image-20260205112040196](https://developer.qcloudimg.com/http-save/yehe-100000/491d5d2f89f87592fc2bd3f3566fc58c.png)

image-20260205112040196

![image-20260205112847778](https://developer.qcloudimg.com/http-save/yehe-100000/9eb241c70a08ebbec7543b11ade906f5.png)

image-20260205112847778

觉得设计没问题之后，将模式切换为 `Build`，开始真正设计页面。

![image-20260205113037233](https://developer.qcloudimg.com/http-save/yehe-100000/1cdf45864640f6abc44ff648824dc83b.png)

image-20260205113037233

在 VS Code 里面可以看到预览。

![image-20260205113905182](https://developer.qcloudimg.com/http-save/yehe-100000/ad72868a030eac06af121f7dad6c13e8.png)

image-20260205113905182

![image-20260205113354777](https://developer.qcloudimg.com/http-save/yehe-100000/755c2d53f300f45550e7f7d5b5c368af.png)

image-20260205113354777
...
![image-20260205115153739](https://developer.qcloudimg.com/http-save/yehe-100000/42b285130191e39f87aefeef1a120b33.png)

image-20260205115153739

在项目里面执行 `openspec init` 初始化 OpenSpec 文件，绑定使用 OpenCode，设置完成后需要重启 OpenCode。

> 可以多选，同时在一个项目里面使用不同的工具。

![image-20260205115443385](https://developer.qcloudimg.com/http-save/yehe-100000/40620b63bbc489129a2bb2a1739f65f7.png)

image-20260205115443385

OpenSpec 会跟项目创建 `.openspec` 目录和 `AGENTS.md` 文件，第一次初始化时，`.openspec` 目录结构比较简单，但是后面随着迭代，目录会越来越复杂。

![image-20260205115646611](https://developer.qcloudimg.com/http-save/yehe-100000/1862c4d98180eda15266ac40c0054791.png)

image-20260205115646611
...
![image-20260205140615775](https://developer.qcloudimg.com/http-save/yehe-100000/065a1250dde4b80561f21c8b059b00b1.png)

image-20260205140615775
...
![image-20260205223926980](https://developer.qcloudimg.com/http-save/yehe-100000/a0ac7ea42adaf948c412915f79da7031.png)

image-20260205223926980
...
![image-20260205144928202](https://developer.qcloudimg.com/http-save/yehe-100000/5041243e6604bd5484133d1aa0581a92.png)

image-20260205144928202

接着把 “我需要什么功能” 贴到对话框，**让 AI 帮助你把想法变为具体的需求说明**。你可以在对话中继续跟 AI 探讨明确目标，确认架构规划，然后进入下一阶段。

![image-20260205144451993](https://developer.qcloudimg.com/http-save/yehe-100000/9edfc32f1fff607057973809f1e1a0f8.png)

image-20260205144451993
...
![image-20260205150053070](https://developer.qcloudimg.com/http-save/yehe-100000/adea6b544448615b459bdff38956424a.png)

image-20260205150053070
...
![image-20260205150839593](https://developer.qcloudimg.com/http-save/yehe-100000/5475d79583b95ea0310ee1272318d23d.png)

image-20260205150839593
...
![image-20260205151456733](https://developer.qcloudimg.com/http-save/yehe-100000/30ae6030910e60986fc5687334d06dcf.png)

image-20260205151456733
...
![image-20260205151415959](https://developer.qcloudimg.com/http-save/yehe-100000/0c9f7e8079372a1e7686dd635e669477.png)

image-20260205151415959
...
1.  上下文加载：[人工智能](https://cloud.tencent.com/product/ai-class?from_column=20065&from=20065)读取 proposal.md 和规范/以理解需求。
2.  执行:AI 按顺序处理 tasks.md。
3.  跟踪：任务实时标记为已完成。

前面提到，如果上下文太长，需要新开对话；或者今天偷懒不写代码，第二天写的时候忘记了进度，那么可以使用 `/opsx-continue [change-name]` 恢复进度。

![image-20260205153010435](https://developer.qcloudimg.com/http-save/yehe-100000/ed0f16840914dde0c68eebc7b2f3509b.png)

image-20260205153010435

如下图，第一阶段的四个步骤已经完成了，提示我们下一步可以使用 `/opsx-apply`、`/opsx-archive` 执行编码任务了。

![image-20260205153042693](https://developer.qcloudimg.com/http-save/yehe-100000/b0ea6aab7ff9a575396b9632cd2805df.png)

image-20260205153042693
...
![image-20260205160114683](https://developer.qcloudimg.com/http-save/yehe-100000/7ba5128115970ef87ee6251ff0ee9c19.png)

image-20260205160114683
...
因为 OpenSpec 没有数据，也不存[数据库](https://cloud.tencent.com/product/tencentdb-catalog?from_column=20065&from=20065)，所以主要是根据目录文件来判断工作状态，如果不整理文件，会导致检索时的文件内容很多，把没必要的文件也读取进去了。
...
![image-20260205162649717](https://developer.qcloudimg.com/http-save/yehe-100000/55aff743795fb104cce237d8bfabbfd1.png)

image-20260205162649717

目前界面只是有个架子，功能还是不可用的，我们可以新开一个 `change` 按一个模块去增加功能，不要一个 `change` 干一堆事情，小步快跑、逐步积累。

![image-20260205164224697](https://developer.qcloudimg.com/http-save/yehe-100000/bc5530a30ca1d2583db6f62e629787d3.png)

image-20260205164224697

![image-20260205164956608](https://developer.qcloudimg.com/http-save/yehe-100000/0921a09bdfa404d684e11db314759fba.png)

image-20260205164956608
...
原始发表：2026-02-06，如有侵权请联系 [cloudcommunity@tencent.com](mailto:cloudcommunity@tencent.com) 删除